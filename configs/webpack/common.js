...
module.exports = {
  entry: {
    ...
    plugin: "./src/lms/plugin/index.tsx",
    parentalConsent: "./src/components/ParentalConsent/index.tsx",
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: resolve(__dirname, "../../src/components/Login/login.html.ejs"),
      filename: "login.html",
      chunks: ["login"],
    }),
    new HtmlWebpackPlugin({
      template: resolve(__dirname, "../../src/lms/plugin/plugin.html.ejs"),
    ...
    new HtmlWebpackPlugin({
      template: resolve(
        __dirname,
        "../../src/components/ParentalConsent/parental-consent.html.ejs"
      ),
