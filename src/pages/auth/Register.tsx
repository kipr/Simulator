...
interface SignUpProps extends ThemeProps,StyleProps {
...
export class Register extends React.Component<Props, State> {
  ...
  private onKeyDown_ = (event: React.KeyboardEvent<HTMLInputElement>) => {
    ...
    this.props.isRegisterOpen && document.getElementById('register-button').click();
  };
      ...
      <div className="auth-main-container">
        <div className="sign-up-wrapper">
          ...
          <div className="input-buttons">
            <button 
              ...
              onClick={() => this.props.signUpWithEmail(this.state.email, this.state.password)}>
                Register
            </button>
          </div>
        </div>
        <div className="google-btn-wrapper">
          ...
          <button 
            ...
            disabled={this.props.authenticating} 
            onClick={() => this.props.signInWithSocialMedia(Providers.google)}>
