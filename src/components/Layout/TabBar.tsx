...
const TabContainer = styled(
  "div",
  (props: ThemeProps & { selected: boolean; $vertical: boolean }) => ({
    flex: "1 1",
...
const TabBarContainer = styled(
  "div",
  (props: ThemeProps & { $vertical: boolean }) => ({
    display: "flex",
