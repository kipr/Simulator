...
export namespace Size {
  ...
  export const PARTIAL_UP: Partial = {
    type: Type.Partial,
    direction: Direction.Up,
  };
  export const PARTIAL_DOWN: Partial = {
    type: Type.Partial,
    direction: Direction.Down,
  };
  export const PARTIAL_LEFT: Partial = {
    type: Type.Partial,
    direction: Direction.Left,
  };
  export const PARTIAL_RIGHT: Partial = {
    type: Type.Partial,
  ...
  export const MINIATURE_UP: Miniature = {
    type: Type.Miniature,
    direction: Direction.Up,
  };
  export const MINIATURE_DOWN: Miniature = {
    type: Type.Miniature,
    direction: Direction.Down,
  };
  export const MINIATURE_LEFT: Miniature = {
    type: Type.Miniature,
    direction: Direction.Left,
  };
  export const MINIATURE_RIGHT: Miniature = {
    type: Type.Miniature,
    direction: Direction.Right,
  };
...
const Chrome = styled(
  ...
  (
    ...
    cursor:
      props.$onChromeMouseDown || props.$onChromeMouseUp ? "grab" : undefined,
  })
);

const Title = styled(
  "span",
  (props: ThemeProps & { $hasComponents: boolean }) => ({
    fontWeight: 400,
    fontSize: "18px",
    userSelect: "none",
    paddingRight: props.$hasComponents
      ? `${props.theme.itemPadding}px`
      : undefined,
    marginRight: props.$hasComponents
      ? `${props.theme.itemPadding}px`
      : undefined,
    borderRight: props.$hasComponents
  ...
  switch (size.type) {
    case Size.Type.Partial: {
      switch (size.direction) {
        case Size.Direction.None:
          return faWindowRestore;
        case Size.Direction.Up:
          return faAngleUp;
        case Size.Direction.Down:
          return faAngleDown;
        case Size.Direction.Left:
          return faAngleLeft;
        case Size.Direction.Right:
          return faAngleRight;
        default:
          return null;
      }
    ...
    return (
      <Container style={style} className={className} theme={theme} mode={mode}>
        ...
        >
          <Title
            theme={theme}
            $hasComponents={barComponents && barComponents.length > 0}
          >
            {name}
          </Title>
          {barComponents
