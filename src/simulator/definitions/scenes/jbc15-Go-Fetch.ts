...
export const JBC_15: Scene = {
  ...
  summary: {
    skill: tr('Precision robot driving and engineering an effector to pick up a can.'),
    baseMission: tr('Drive to pick up the can in circle 11 and return it to the starting box.')
  },
  scripts: {
