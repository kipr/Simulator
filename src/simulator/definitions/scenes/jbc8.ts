...
scene.onBind = nodeId => {
  ...
  scene.addOnIntersectionListener('robot', (type, otherNodeId) => {
    ...
    switch(count){
      ...
      case 6:
        if(otherNodeId == "n6"){
         setNodeVisible('circle6',true);
         scene.setChallengeEventValue('passed6', true);
        }
      break;
      case 7:
        if(otherNodeId == "n7"){
         setNodeVisible('circle7',true);
         scene.setChallengeEventValue('passed7', true);
        }
      break;
      case 8:
        if(otherNodeId == "n8"){
         setNodeVisible('circle8',true);
         scene.setChallengeEventValue('passed8', true);
        }
      break;
    }
  ...
  }, ['startBox', 'circle1','circle2','circle3','circle4','circle5','circle6','circle7','circle8',
