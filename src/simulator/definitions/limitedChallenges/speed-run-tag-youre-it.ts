...
export default {
  name: tr('Speed Run: Tag, You\'re it!'),
  description: tr('Complete the Tag, You\'re it! challenge as fast as possible! Limited time event.'),
  author: {
  ...
  sceneId: 'jbc1',
  openDate: '2026-01-25T00:00:00Z',
  closeDate: '2026-03-18T23:59:59Z',
} as LimitedChallenge;
