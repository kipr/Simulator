import { Texture, DynamicTexture, StandardMaterial, Color3, PBRMaterial, 
  Scene as babylonScene, Material as babylMaterial, GlowLayer } from '@babylonjs/core';
...
export const createMaterial = (id: string, material: Material, bScene_: babylonScene) => {
...
export const updateMaterialBasic = (bMaterial: StandardMaterial, material: Patch.InnerPatch<Material.Basic>, bScene_: babylonScene) => {
  const { color } = material;
...
export const updateMaterialPbr = (bMaterial: PBRMaterial, material: Patch.InnerPatch<Material.Pbr>, bScene_: babylonScene) => {
  const { albedo, ambient, emissive, metalness, reflection } = material;
