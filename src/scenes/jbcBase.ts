...
const canPositions: Vector3[] = [
  {
    x: Distance.centimeters(-22),
    y: Distance.centimeters(110),
    z: Distance.centimeters(-14.3),
  },
  {
    x: Distance.centimeters(0),
    y: Distance.centimeters(110),
    z: Distance.centimeters(-20.6),
  },
  {
    x: Distance.centimeters(15.5),
    y: Distance.centimeters(110),
    z: Distance.centimeters(-23.7),
  },
  {
    x: Distance.centimeters(0),
    y: Distance.centimeters(110),
  ...
  {
    x: Distance.centimeters(-13.7),
    y: Distance.centimeters(110),
    z: Distance.centimeters(6.8),
  },
  {
    x: Distance.centimeters(0),
    y: Distance.centimeters(110),
  ...
  {
    x: Distance.centimeters(13.5),
    y: Distance.centimeters(110),
    z: Distance.centimeters(6.8),
  },
  {
    x: Distance.centimeters(25.1),
    y: Distance.centimeters(110),
  ...
  },
  {
    x: Distance.centimeters(0),
    y: Distance.centimeters(110),
    z: Distance.centimeters(34),
  },
  {
    x: Distance.centimeters(-18.8),
    y: Distance.centimeters(110),
    z: Distance.centimeters(45.4),
  },
  {
    x: Distance.centimeters(0),
    y: Distance.centimeters(110),
    z: Distance.centimeters(54.9),
  },
  {
    x: Distance.centimeters(18.7),
    y: Distance.centimeters(110),
    z: Distance.centimeters(45.4),
  },
];