...
export type TourStep = {
  ...
  /** Advance when the owning page signals that the required UI change finished. */
  advanceOnContinue?: boolean;
  /** Treat Next on this step as finishing the current tour. */
  endsTour?: boolean;
  /** Continue to a specific step instead of the next step in array order. */
  nextStepId?: string;
...
export function getSimMainMenuTourSteps(locale: LocalizedString.Language): TourStep[] {
  return [ // Main Menu Overview Step
    ...
    {
      id: 'create-your-own-challenge-option',
      targetKey: 'create-your-own-challenge-option',
      title: LocalizedString.lookup(tr('Create Your Own JBC Challenge'), locale),
      content: LocalizedString.lookup(tr('Select "Create Your Own Challenge" to start building a custom JBC challenge from the sandbox.'), locale),
      placement: 'right',
      allowTargetInteraction: true,
      noNextButton: true,
      advanceOnContinue: true,
    ...
    {
      id: 'create-your-own-challenge-info',
      targetKey: 'open-scene-info',
      title: LocalizedString.lookup(tr('Custom JBC Challenge Info'), locale),
      content: LocalizedString.lookup(tr('The info panel explains that this option launches a guided setup wizard for custom JBC challenges.'), locale),
      placement: 'right',
      allowTargetInteraction: false,
    },
    {
      id: 'create-your-own-challenge-accept',
      targetKey: 'open-scene-accept',
      title: LocalizedString.lookup(tr('Open Custom Challenge Setup'), locale),
      content: LocalizedString.lookup(tr('Click Accept to open the custom JBC challenge instructions.'), locale),
      placement: 'top',
      allowTargetInteraction: true,
      noNextButton: true,
      advanceOnContinue: true,
    ...
    {
      id: 'create-your-own-challenge-instructions',
      targetKey: 'create-your-own-challenge-instructions',
      title: LocalizedString.lookup(tr('Custom Challenge Instructions'), locale),
      content: LocalizedString.lookup(tr('These instructions introduce the custom JBC challenge setup flow before you enter the sandbox wizard.'), locale),
      placement: 'right',
      allowTargetInteraction: false,
    },
    {
      id: 'create-your-own-challenge-continue',
      targetKey: 'create-your-own-challenge-continue',
      title: LocalizedString.lookup(tr('Continue To Setup'), locale),
      content: LocalizedString.lookup(tr('Click Continue to open the custom JBC challenge setup wizard.'), locale),
      placement: 'top',
      allowTargetInteraction: true,
      noNextButton: true,
      advanceOnContinue: true,
    ...
    {
      id: 'custom-challenge-setup-dialog',
      targetKey: 'custom-challenge-setup-dialog',
      title: LocalizedString.lookup(tr('Custom JBC Challenge Setup'), locale),
      content: LocalizedString.lookup(tr('This wizard walks you through naming the challenge, placing items, and choosing success and failure rules.'), locale),
      placement: 'auto',
      allowTargetInteraction: false,
    },
    {
      id: 'custom-challenge-name-field',
      targetKey: 'custom-challenge-name-field',
      title: LocalizedString.lookup(tr('Name Your Challenge'), locale),
      content: LocalizedString.lookup(tr('Enter a name for your custom JBC challenge so it is easy to find later.'), locale),
      placement: 'right',
      allowTargetInteraction: true,
    },
    {
      id: 'custom-challenge-description-field',
      targetKey: 'custom-challenge-description-field',
      title: LocalizedString.lookup(tr('Describe The Goal'), locale),
      content: LocalizedString.lookup(tr('Use the description to explain what the robot should accomplish in this challenge.'), locale),
      placement: 'right',
      allowTargetInteraction: true,
    },
    {
      id: 'custom-challenge-details-continue',
      targetKey: 'custom-challenge-details-continue',
      title: LocalizedString.lookup(tr('Continue To Mat Setup'), locale),
      content: LocalizedString.lookup(tr('Click Continue when the name and description are ready.'), locale),
      placement: 'top',
      allowTargetInteraction: true,
      noNextButton: true,
      advanceOnContinue: true,
    ...
    {
      id: 'custom-challenge-mat-setup-panel',
      targetKey: 'custom-challenge-mat-setup-panel',
      title: LocalizedString.lookup(tr('Set Up The Mat'), locale),
      content: LocalizedString.lookup(tr('This step is where you choose what appears on the mat and define any regions the robot should interact with.'), locale),
      placement: 'left',
      allowTargetInteraction: false,
    },
    {
      id: 'custom-challenge-mat-setup-objects',
      targetKey: 'custom-challenge-mat-setup-objects',
      title: LocalizedString.lookup(tr('Objects'), locale),
      content: LocalizedString.lookup(tr('Use Objects to place cans, paper reams, and other physical items that should be part of the custom challenge.'), locale),
      placement: 'left',
      allowTargetInteraction: false,
    },
    {
      id: 'custom-challenge-mat-setup-markers',
      targetKey: 'custom-challenge-mat-setup-markers',
      title: LocalizedString.lookup(tr('Markers'), locale),
      content: LocalizedString.lookup(tr('Use Markers for start boxes, lines, and other invisible or visible script zones used by challenge events.'), locale),
      placement: 'left',
      allowTargetInteraction: false,
    },
    {
      id: 'custom-challenge-mat-setup-play-areas',
      targetKey: 'custom-challenge-mat-setup-play-areas',
      title: LocalizedString.lookup(tr('Play Areas'), locale),
      content: LocalizedString.lookup(tr('Use Play areas to draw adjustable regions on the mat, name them, and attach goals like entering or avoiding a region.'), locale),
      placement: 'left',
      allowTargetInteraction: false,
    },
    {
      id: 'custom-challenge-mat-setup-continue',
      targetKey: 'custom-challenge-mat-setup-continue',
      title: LocalizedString.lookup(tr('Continue To Success Rules'), locale),
      content: LocalizedString.lookup(tr('After the mat setup looks right, click Continue to choose what counts as success.'), locale),
      placement: 'top',
      allowTargetInteraction: true,
      noNextButton: true,
      advanceOnContinue: true,
    ...
    {
      id: 'custom-challenge-success-panel',
      targetKey: 'custom-challenge-success-panel',
      title: LocalizedString.lookup(tr('Choose Success Rules'), locale),
      content: LocalizedString.lookup(tr('Pick what counts as success for the robot and the selected items. Click Continue when the success rules are ready.'), locale),
      placement: 'left',
      allowTargetInteraction: true,
      noNextButton: true,
      advanceOnContinue: true,
    ...
    {
      id: 'custom-challenge-failure-panel',
      targetKey: 'custom-challenge-failure-panel',
      title: LocalizedString.lookup(tr('Choose Failure Rules'), locale),
      content: LocalizedString.lookup(tr('Review or adjust the failure rules that can end the run early. Click Continue when these look right.'), locale),
      placement: 'left',
      allowTargetInteraction: true,
      noNextButton: true,
      advanceOnContinue: true,
    ...
    {
      id: 'custom-challenge-review-panel',
      targetKey: 'custom-challenge-review-panel',
      title: LocalizedString.lookup(tr('Review Your Custom Challenge'), locale),
      content: LocalizedString.lookup(tr('Review the challenge setup here. When you are ready, click Create challenge to return to the JBC Sandbox and continue the tour.'), locale),
      placement: 'left',
      allowTargetInteraction: true,
      noNextButton: true,
      advanceOnContinue: true,
      nextStepId: 'extra-menu-button',
    },
    // Close Scene Dialog Step
    {
      ...
      title: LocalizedString.lookup(tr('Scene Open Continued'), locale),
      content: LocalizedString.lookup(tr('Select the X at the top of the Open World dialog to close it and continue the tour.'), locale),
      placement: 'top',
      allowTargetInteraction: true,
      noNextButton: true,
      advanceOnContinue: true,
...
const SimMainMenuSteps: TourStep[] = [
  ...
  },
  {
    id: 'create-your-own-challenge-option',
    targetKey: 'create-your-own-challenge-option',
    title: 'Create Your Own JBC Challenge',
    content: 'Select "Create Your Own Challenge" to start building a custom JBC challenge from the sandbox.',
    placement: 'right',
    allowTargetInteraction: true,
    noNextButton: true,
    advanceOnContinue: true,
  },
  {
    id: 'create-your-own-challenge-info',
    targetKey: 'open-scene-info',
    title: 'Custom JBC Challenge Info',
    content: 'The info panel explains that this option launches a guided setup wizard for custom JBC challenges.',
    placement: 'right',
    allowTargetInteraction: false,
  },
  {
    id: 'create-your-own-challenge-accept',
    targetKey: 'open-scene-accept',
    title: 'Open Custom Challenge Setup',
    content: 'Click Accept to open the custom JBC challenge instructions.',
    placement: 'top',
    allowTargetInteraction: true,
    noNextButton: true,
    advanceOnContinue: true,
  },
  {
    id: 'create-your-own-challenge-instructions',
    targetKey: 'create-your-own-challenge-instructions',
    title: 'Custom Challenge Instructions',
    content: 'These instructions introduce the custom JBC challenge setup flow before you enter the sandbox wizard.',
    placement: 'right',
    allowTargetInteraction: false,
  },
  {
    ...
    content: 'Click Continue to open the custom JBC challenge setup wizard.',
    placement: 'top',
    allowTargetInteraction: true,
    noNextButton: true,
    advanceOnContinue: true,
  },
  {
    id: 'custom-challenge-setup-dialog',
    targetKey: 'custom-challenge-setup-dialog',
    title: 'Custom JBC Challenge Setup',
    content: 'This wizard walks you through naming the challenge, placing items, and choosing success and failure rules.',
    placement: 'auto',
    allowTargetInteraction: false,
  },
  {
    ...
    content: 'Enter a name for your custom JBC challenge so it is easy to find later.',
    placement: 'right',
    allowTargetInteraction: true,
  },
  {
    ...
    content: 'Use the description to explain what the robot should accomplish in this challenge.',
    placement: 'right',
    allowTargetInteraction: true,
  },
  {
    id: 'custom-challenge-details-continue',
    targetKey: 'custom-challenge-details-continue',
    title: 'Continue To Mat Setup',
    content: 'Click Continue when the name and description are ready.',
    placement: 'top',
    allowTargetInteraction: true,
    noNextButton: true,
    advanceOnContinue: true,
  },
  {
    id: 'custom-challenge-mat-setup-panel',
    targetKey: 'custom-challenge-mat-setup-panel',
    title: 'Set Up The Mat',
    content: 'This step is where you choose what appears on the mat and define any regions the robot should interact with.',
    placement: 'left',
    allowTargetInteraction: false,
  },
  {
    ...
    targetKey: 'custom-challenge-mat-setup-objects',
    title: 'Objects',
    content: 'Use Objects to place cans, paper reams, and other physical items that should be part of the custom challenge.',
    placement: 'left',
    allowTargetInteraction: false,
  },
  {
    ...
    targetKey: 'custom-challenge-mat-setup-markers',
    title: 'Markers',
    content: 'Use Markers for start boxes, lines, and other invisible or visible script zones used by challenge events.',
    placement: 'left',
    allowTargetInteraction: false,
  },
  {
    ...
    targetKey: 'custom-challenge-mat-setup-play-areas',
    title: 'Play Areas',
    content: 'Use Play areas to draw adjustable regions on the mat, name them, and attach goals like entering or avoiding a region.',
    placement: 'left',
    allowTargetInteraction: false,
  },
  {
    id: 'custom-challenge-mat-setup-continue',
    targetKey: 'custom-challenge-mat-setup-continue',
    title: 'Continue To Success Rules',
    content: 'After the mat setup looks right, click Continue to choose what counts as success.',
    placement: 'top',
    allowTargetInteraction: true,
    noNextButton: true,
    advanceOnContinue: true,
  },
  {
    id: 'custom-challenge-success-panel',
    targetKey: 'custom-challenge-success-panel',
    title: 'Choose Success Rules',
    content: 'Pick what counts as success for the robot and the selected items. Click Continue when the success rules are ready.',
    placement: 'left',
    allowTargetInteraction: true,
    noNextButton: true,
    advanceOnContinue: true,
  },
  {
    id: 'custom-challenge-failure-panel',
    targetKey: 'custom-challenge-failure-panel',
    title: 'Choose Failure Rules',
    content: 'Review or adjust the failure rules that can end the run early. Click Continue when these look right.',
    placement: 'left',
    allowTargetInteraction: true,
    noNextButton: true,
    advanceOnContinue: true,
  },
  {
    id: 'custom-challenge-review-panel',
    targetKey: 'custom-challenge-review-panel',
    title: 'Review Your Custom Challenge',
    content: 'Review the challenge setup here. When you are ready, click Create challenge to return to the JBC Sandbox and continue the tour.',
    placement: 'left',
    allowTargetInteraction: true,
    noNextButton: true,
    advanceOnContinue: true,
  ...
  // Close Scene Dialog Step
  {
    ...
    targetKey: 'close-scene-dialog',
    title: 'Scene Open Continued',
    content: 'Select the X at the top of the Open World dialog to close it and continue the tour.',
    placement: 'top',
    allowTargetInteraction: true,
    noNextButton: true,
    advanceOnContinue: true,
